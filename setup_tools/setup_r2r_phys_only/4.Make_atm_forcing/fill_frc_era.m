...
start_date = datenum(2019,2,1);
end_date   = datenum(2020,4,1);
...
grdname= '/glade/scratch/bachman/ROMS_tools/setup_r2r_phys_only/1.Make_grid/CT1_grd.nc';
root_name= '/glade/scratch/bachman/ROMS_tools/setup_r2r_phys_only/1.Make_grid/CT1';
