...
pdir    = '/glade/scratch/bachman/ROMS_tools/setup_r2r_phys_only/1.Make_grid/';
pname   = 'CT1_grd.nc';
ename   = 'CT1_edata.nc';

% Child grid directory and file name
cdir    = '/glade/scratch/bachman/ROMS_tools/CT/CT2/1.Make_grid/';
cname   = 'CT2_grd.nc';
gname   = 'CT2'   % Can't use underscores here
