...
pdir    = '/glade/scratch/bachman/ROMS_tools/Iceland0_BGC2/1.Make_grid/';
pname   = 'Iceland0_grd.nc';
ename   = 'Iceland0_edata.nc';

% Child grid directory and file name
cdir    = '/glade/scratch/bachman/ROMS_tools/Iceland1/EASY/';
cname   = 'Iceland1_grd.nc';
gname   = 'Iceland1'   % Can't use underscores here
