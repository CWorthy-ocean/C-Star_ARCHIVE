...
pdir    = '/glade/scratch/bachman/ROMS_tools/setup_s2r_phys_only/1.Make_grid/';
pname   = 'Wales0_grd.nc';
ename   = 'Wales0_edata.nc';

% Child grid directory and file name
cdir    = '/glade/scratch/bachman/ROMS_tools/setup_s2r_phys_only/1.Make_grid/';
cname   = 'Wales1_grd.nc';
gname   = 'Wales1'   % Can't use underscores here
