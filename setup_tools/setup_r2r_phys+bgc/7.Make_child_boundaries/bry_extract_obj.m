...
pdir    = '/glade/scratch/bachman/ROMS_tools/setup_r2r_phys+bgc/1.Make_grid/';
pname   = 'Iceland1_grd.nc';
ename   = 'Iceland1_edata.nc';

% Child grid directory and file name
cdir    = '/glade/scratch/bachman/ROMS_tools/Iceland2/EASY/';
cname   = 'Iceland2_grd.nc';
gname   = 'Iceland2'   % Can't use underscores here
...
v_vars   = 'vbar, v, vp';
  ...
  if obc_west
    ...
    sms = fix_bry_mask(ename,obj_name,mskp);
